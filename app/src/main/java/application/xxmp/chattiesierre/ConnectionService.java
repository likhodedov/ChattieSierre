...
public class ConnectionService extends Service {
    ...
    public static final String UI_AUTHENTICATED = "application.xxmp.chattiesierre.uiauthenticated";
    public static final String SEND_MESSAGE = "application.xxmp.chattiesierre.sendmessage";
    public static final String BUNDLE_MESSAGE_BODY = "b_body";
    public static final String BUNDLE_TO = "b_to";
    public static final String READ_MESSAGES_FROM_STORE="application.xxmp.chattiesierre.readmessagesfromstore";
    public static final String NEW_MESSAGE = "application.xxmp.chattiesierre.newmessage";
